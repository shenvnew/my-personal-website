...
export default function Hero() {
  return (
    <section id="home" className="px-6 pb-20 pt-16 lg:px-8 lg:pt-24">
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
        <div className="space-y-7">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="#projects"
              className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-blue-500 to-violet-500 px-6 py-3 font-medium text-white"
            >
              View Projects
              <ArrowRight size={18} />
            </a>
          ...
          <div className="flex items-center gap-4 pt-3 text-slate-300">
            <a href="#" className="rounded-xl border border-white/10 bg-white/5 p-3">
              <Github size={18} />
            </a>
            <a href="#" className="rounded-xl border border-white/10 bg-white/5 p-3">
              <Linkedin size={18} />
            </a>
            <a href="mailto:you@example.com" className="rounded-xl border border-white/10 bg-white/5 p-3">
              <Mail size={18} />
            </a>
          </div>
        </div>
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative w-full max-w-md rounded-[2rem] border border-white/10 bg-white/5 p-6">
            <div className="relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-slate-900/80 p-5">
              ...
              <div className="mb-5 flex justify-center">
                <div className="h-64 w-64 overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-blue-500/30 to-violet-500/30 p-2">
                  <img
